...
var binaryString = str.split(" ");
  ...
  for (i = 0; i < size; i += 1) {
    newString.push(String.fromCharCode(parseInt(binaryString[i], 2)));
  }
...
//Метод split() разделяет строку на массив строк путем разделения строки на подстроки
//fromCharCode() возвращает строку, созданную из указанной последовательности значений единиц кода UTF-16.
